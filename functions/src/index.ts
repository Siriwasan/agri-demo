...
// With mapping in firebase.json
// http://localhost:5000/[project name]/us-central1/main/api
// https://us-central1-[project name].cloudfunctions.net/main/api
// https://[project name].firebaseapp.com/api/